...
const CreateQuery = () => {
    ...
    const notifySuccess = () => toast.success('New query added!');
    ...
    return(
        <div className="container bg-light px-3 py-2">
            ...
            <h2 className="text-center my-2">Create New Query</h2>
   ...
   className="form-check-input ms-2"
                ...
                <button type="submit" className="btn btn-sm btn-success my-2 me-2">Add Query</button>
